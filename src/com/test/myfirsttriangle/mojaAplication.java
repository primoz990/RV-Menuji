...
public class mojaAplication extends AndroidApplication
{
	Button potrdi;
	Spinner spin;
    ...
    public void odpriActiviti(String kera)
    {
    	Intent in = new Intent();
    	if(kera=="3") in = new Intent(this, OpisAvtorja.class);
    	else in = new Intent(this, opisAplikacijeActivity.class);
    	
    	startActivity(in);
    }
    
    public void odpriApp()
    {
    	Intent LaunchIntent;
		try 
		{
			
			LaunchIntent = getPackageManager().getLaunchIntentForPackage("edu.PrimozRezek.iManager.android");
			startActivity( LaunchIntent );
			
		} catch (NameNotFoundException e) 
		{
			Log.e("Napaka", "Verjetno nimate nameščenega paketa edu.PrimozRezek.iManager.android");
		}
		
		mojaAplication.this.finish();
    ...
    //----------------------------------RAZRED za prikazovanje z LIBGDX----------------------------------------------
